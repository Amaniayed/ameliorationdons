  ...
  return (  
    <View style={styles.container}>
      ...
      >
        ...
        <TouchableOpacity style={styles.image_un} onPress={() => navigation.navigate('Connexion')}>
          <Image source={require('../../assets/Ellipse.png')} />
        </TouchableOpacity>

        {/* Élément flèche cliquable */}
        <TouchableOpacity style={styles.image_deux} onPress={() => navigation.navigate('Connexion')}>
